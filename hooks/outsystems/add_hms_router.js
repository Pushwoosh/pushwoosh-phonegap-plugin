...
function copyJavaFile(srcFile) {
    ...
    console.error(TAG, "Error copying HuaweiMessagingRouterService:", error.message);
    return false;
  }
}
...
module.exports = function(context) {
    ...
    return new Promise(function(resolve, reject) {
        ...
        if (zipFile) {
            ...
            if (!copyWithSuccess) {
                console.log(TAG, "ERROR: Unable to copy HuaweiMessagingRouterService");
                return reject(
            ...
            console.log(TAG, "No HMS router zip found, skipping");
        }
